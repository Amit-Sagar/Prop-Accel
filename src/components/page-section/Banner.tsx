...
const Banner = () => {
  return (
    <div className="h-[652px] relative  z-50">
      <div className="w-[580px] left-[175px] top-[174px] absolute">
      ...
      <div className="w-[550px] h-[370px] left-[774.10px] top-[233.96px] absolute">
        <img src={dots} alt="/dots" />
      </div>
      <img
        className="w-[491px] h-[281px] left-[773px] top-[174px] absolute rounded-lg"
        src={classroom}
        alt="/classroom"
      />
      <img
        className="w-[491px] h-[281px] left-[720px] top-[264px] absolute rounded-lg"
        src={business}
        alt="/business"
      />
      <div className="w-[63px] h-[62px] px-[7px] py-0.5 left-[1253.19px] top-[511px] absolute origin-top-left rotate-[15.14deg] bg-white rounded shadow justify-center items-center gap-2.5 inline-flex">
        <div className="w-[35.71px] h-[46.43px] relative">
          <img src={microphone} alt="/microphone" />
        </div>
      </div>
      <div className="w-[65px] h-[65px] px-[3px] py-[7px] left-[1295px] top-[344.82px] absolute origin-top-left rotate-[-16.83deg] bg-white rounded shadow flex-col justify-center items-center gap-2.5 inline-flex">
